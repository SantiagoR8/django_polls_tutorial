...
def create_question(question_text, days):
    ...
    question.choice_set.create(choice_text='Option 1')
    return question 
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        self.assertQuerysetEqual(
            ...
            past_question.choice_set.all(),
            # Overrides the transform argument from repr() to lambda functio
            # to avoid quotes problem ('x' is not equal to x).
            # One could also use: map(repr, past_question.choice_set.all())
